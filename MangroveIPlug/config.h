...
#define AUV2_ENTRY MangroveIPlug_Entry
#define AUV2_ENTRY_STR "MangroveIPlug_Entry"
#define AUV2_FACTORY MangroveIPlug_Factory
#define AUV2_VIEW_CLASS AUPlugInCocoaViewMangroveIPlug
#define AUV2_VIEW_CLASS_STR "AUPlugInCocoaViewMangroveIPlug"

#define AAX_TYPE_IDS 'Mng5'
//#define AAX_TYPE_IDS_AUDIOSUITE 'EFA1', 'EFA2'
#define AAX_PLUG_MFR_STR "Nss2"
#define AAX_PLUG_NAME_STR "Mangrove\nMng5"
#define AAX_PLUG_CATEGORY_STR "Compressor"
