#include "MangroveIPlug.h"
#include "IPlug_include_in_plug_src.h"
#include "IPlugPaths.h"
#include "IconsForkAwesome.h"
#include "IconsFontaudio.h"

MangroveIPlug::MangroveIPlug(const InstanceInfo& info)
...
//    };
//
//    pGraphics->AttachControl(new IWebViewControl(b.GetCentredInside(200), false, readyFunc, msgFunc, "C:\\Users\\oli\\Dev\\iPlug2\\Examples\\MangroveIPlug\\WebView2Loader.dll", "C:\\Users\\oli\\Dev\\iPlug2\\Examples\\MangroveIPlug\\"));
...
#pragma mark - About Box
    ...
    pGraphics->AttachControl(new IAboutBoxControl(b,
            ...
            [](IContainerBase* pParent, const IRECT& r) {
              pParent->AddChildControl(new ITextControl(IRECT(), "MangroveIPlug Example", {DEFAULT_TEXT_SIZE * 5, COLOR_WHITE}));
...
#if IPLUG_EDITOR
void MangroveIPlug::FlashBlueLED()
{
  GetUI()->GetControlWithTag(kCtrlTagBlueLED)->As<ILEDControl>()->TriggerWithDecay(1000);
}

void MangroveIPlug::OnMidiMsgUI(const IMidiMsg& msg)
{
  if(GetUI())
  {
...
void MangroveIPlug::OnReset()
{
  mPeakAvgMeterSender.Reset(GetSampleRate());
}

void MangroveIPlug::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
